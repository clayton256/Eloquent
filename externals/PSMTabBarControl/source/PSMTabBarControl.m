...
- (NSLineBreakMode)truncationStyle {
    ...
    NSCountedSet *prefixCounts = [[NSCountedSet alloc] init];
    NSCountedSet *suffixCounts = [[NSCountedSet alloc] init];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        if ([aDecoder allowsKeyedCoding]) {
            ...
            _tabView = [aDecoder decodeObjectForKey:@"PSMtabView"];
            ...
            _style = [aDecoder decodeObjectForKey:@"PSMstyle"];
            ...
            _lastMiddleMouseDownEvent = [aDecoder decodeObjectForKey:@"PSMlastMiddleMouseDownEvent"];
            ...
            _delegate = [aDecoder decodeObjectForKey:@"PSMdelegate"];
        }
    }
    return self;
}
