...
+ (void)registerDefaults {
    ...
    [defaultsDict setObject:[NSNumber numberWithFloat:0.0] forKey:DefaultsParagraphSpacingKey];
    [defaultsDict setObject:[NSNumber numberWithFloat:0.0] forKey:DefaultsLineSpacingKey];
